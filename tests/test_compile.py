...
class TestCompile(unittest.TestCase):
    ...
    def testCompile(self):
        ...
        for checkedInFilePath, tempFilePath in utils.zipLists(
            ...
            checkedInHash = self._hashFile(checkedInFilePath)
            tempFileHash = self._hashFile(tempFilePath)
            self.assertEqual(checkedInHash, tempFileHash)
