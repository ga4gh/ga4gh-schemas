...
import ga4gh.schemas.ga4gh.metadata_service_pb2 as ms_pb2  # NOQA
...
class TestImports(unittest.TestCase):
    """
    Ensure the schemas are able to be imported correctly
    """
    ...
    def testGa4ghService(self):
        self.assertIsNotNone(ms_pb2.DESCRIPTOR)
