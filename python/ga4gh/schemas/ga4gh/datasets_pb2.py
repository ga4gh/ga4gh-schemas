...
# source: ga4gh/schemas/ga4gh/datasets.proto
...
Dataset = _reflection.GeneratedProtocolMessageType('Dataset', (_message.Message,), dict(
  DESCRIPTOR = _DATASET,
  __module__ = 'ga4gh.schemas.ga4gh.datasets_pb2'
