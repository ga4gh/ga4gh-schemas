...
_ATTRIBUTES_ATTRIBUTEVALUE = _descriptor.Descriptor(
  name='AttributeValue',
  full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='string_value', full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValue.string_value', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_identifier', full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValue.external_identifier', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ontology_term', full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValue.ontology_term', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValue.value',
...
_ATTRIBUTES_ATTRIBUTEVALUELIST = _descriptor.Descriptor(
  ...
  full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValueList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='values', full_name='ga4gh.schemas.ga4gh.Attributes.AttributeValueList.values', index=0,
...
_ATTRIBUTES_VALSENTRY = _descriptor.Descriptor(
  name='ValsEntry',
  full_name='ga4gh.schemas.ga4gh.Attributes.ValsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.schemas.ga4gh.Attributes.ValsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.schemas.ga4gh.Attributes.ValsEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ATTRIBUTES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='vals', full_name='ga4gh.schemas.ga4gh.Attributes.vals', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURESET_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='ga4gh.schemas.ga4gh.FeatureSet.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.schemas.ga4gh.FeatureSet.InfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.schemas.ga4gh.FeatureSet.InfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURESET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.schemas.ga4gh.FeatureSet.info', index=5,
...
_CONTINUOUSSET_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='ga4gh.schemas.ga4gh.ContinuousSet.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.schemas.ga4gh.ContinuousSet.InfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.schemas.ga4gh.ContinuousSet.InfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONTINUOUSSET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.schemas.ga4gh.ContinuousSet.info', index=5,
      number=6, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_CONTINUOUSSET_INFOENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_ATTRIBUTES_ATTRIBUTEVALUE.fields_by_name['ontology_term'].message_type = ga4gh_dot_schemas_dot_ga4gh_dot_metadata__pb2._ONTOLOGYTERM
...
_CONTINUOUSSET_INFOENTRY.fields_by_name['value'].message_type = google_dot_protobuf_dot_struct__pb2._LISTVALUE
_CONTINUOUSSET_INFOENTRY.containing_type = _CONTINUOUSSET
_CONTINUOUSSET.fields_by_name['info'].message_type = _CONTINUOUSSET_INFOENTRY
...
Attributes = _reflection.GeneratedProtocolMessageType('Attributes', (_message.Message,), dict(
  ...
  AttributeValue = _reflection.GeneratedProtocolMessageType('AttributeValue', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.Attributes.AttributeValue)
    ))
  ,
  ...
  AttributeValueList = _reflection.GeneratedProtocolMessageType('AttributeValueList', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.schemas.ga4gh.sequence_annotations_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.Attributes.AttributeValueList)
    ))
  ,
  ...
  ValsEntry = _reflection.GeneratedProtocolMessageType('ValsEntry', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.schemas.ga4gh.sequence_annotations_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.Attributes.ValsEntry)
    ))
  ,
...
FeatureSet = _reflection.GeneratedProtocolMessageType('FeatureSet', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.schemas.ga4gh.sequence_annotations_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.FeatureSet.InfoEntry)
    ))
  ,
...
ContinuousSet = _reflection.GeneratedProtocolMessageType('ContinuousSet', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    DESCRIPTOR = _CONTINUOUSSET_INFOENTRY,
    __module__ = 'ga4gh.schemas.ga4gh.sequence_annotations_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.ContinuousSet.InfoEntry)
    ))
  ,
...
_sym_db.RegisterMessage(ContinuousSet.InfoEntry)
...
_CONTINUOUSSET_INFOENTRY.has_options = True
_CONTINUOUSSET_INFOENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
