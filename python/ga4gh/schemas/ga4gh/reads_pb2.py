...
_READGROUP_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='ga4gh.schemas.ga4gh.ReadGroup.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.schemas.ga4gh.ReadGroup.InfoEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.schemas.ga4gh.ReadGroup.InfoEntry.value', index=1,
...
_READALIGNMENT_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='ga4gh.schemas.ga4gh.ReadAlignment.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.schemas.ga4gh.ReadAlignment.InfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.schemas.ga4gh.ReadAlignment.InfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READALIGNMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.schemas.ga4gh.ReadAlignment.info', index=15,
...
_READGROUP.fields_by_name['experiment'].message_type = ga4gh_dot_schemas_dot_ga4gh_dot_assay__metadata__pb2._EXPERIMENT
...
ReadGroup = _reflection.GeneratedProtocolMessageType('ReadGroup', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.schemas.ga4gh.reads_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.ReadGroup.InfoEntry)
    ))
  ,
...
ReadAlignment = _reflection.GeneratedProtocolMessageType('ReadAlignment', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.schemas.ga4gh.reads_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.schemas.ga4gh.ReadAlignment.InfoEntry)
    ))
  ,
